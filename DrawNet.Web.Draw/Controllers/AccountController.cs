    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                Lib.Logic.Email.Templates.Account.ResetPassword resetPasswordEmail = new Lib.Logic.Email.Templates.Account.ResetPassword
                {
                ...
                var emailBody = Lib.Core.Services.Email.EmailService.PasswordResetEmail(resetPasswordEmail);
                await Lib.Core.Utilities.Emailer.SendEmail(new MailAddress(DrawNet.Lib.Core.Common.Email.Email_Support), new List<string> { user.Email }, null, null, "Reset Password", emailBody);
